...
class ProjectTokensData
{
    ...
    private static function getTokensData(): array
    {
        ...
        1 => [
            ...
            'price' => '3',
            'effect' => ['updateTrack' => [['track' => 'player-department-technical-development', 'amount' => '+ 1', 'column' => 'any']]],
            'effect_description' => clienttranslate('Улучшите на 1 трек в техотделе'),
            'victory_points' => 2,
            'player_count' => 2,
        ...
        3 => [
            ...
            'price' => '1',
            'effect' => ['updateTrack' => [['track' => 'income-track', 'amount' => '+ 1']]],
        ...
        4 => [
            ...
            'price' => '3',
            'effect' => ['updateTrackSprints' => [['amount' => '+ 1']]],
        ...
        6 => [
            ...
            'price' => '3',
            'effect' => ['updateTrack' => [['track' => 'income-track', 'amount' => '+ 2']]],
        ...
        15 => [
            ...
            'price' => '3',
            'effect' => ['updateTrackSprints' => [['amount' => '+ 2']]],
        ...
        18 => [
            ...
            'price' => '2',
            'effect' => ['updateTrack' => [['track' => 'player-department-back-office-evolution-column-1', 'amount' => '+ 1']]],
            'effect_description' => clienttranslate('Улучшите на 1 трек найма в бэк–офисе'),
            'victory_points' => 2,
            'player_count' => 2,
        ...
        24 => [
            ...
            'price' => '3',
            'effect' => ['updateTrack' => [['track' => 'player-department-back-office-evolution-column-1', 'amount' => '+ 2']]],
            'effect_description' => clienttranslate('Улучшите на 2 трек найма в бэк–офисе'),
            'victory_points' => 3,
            'player_count' => 2,
        ...
        44 => [
            ...
            'price' => '3',
            'effect' => ['updateTrackSprints' => [['amount' => '+ 3']]],
        ...
        // новые буду добавлять сюда
        58 => [
            'number' => 58,
            'color' => 'purple',
            'shape' => 'hex',
            'name' => clienttranslate('Микросервисная архитектура'),
            'price' => '2',
            'effect' => ['updateTrackSprints' => [['amount' => '+ 3']]],
            'effect_description' => clienttranslate('Трек спринта +3'),
            'victory_points' => 0,
            'player_count' => 2,
            'image_url' => 'img/project-tokens/project-hex/58.png',
        ],
        59 => [
            'number' => 59,
            'color' => 'cyan',
            'shape' => 'circle',
            'name' => clienttranslate('Маркетплейс'),
            'price' => '4',
            'effect' => ['updateTrack' => [['track' => 'income-track', 'amount' => '+ 4']]],
            'effect_description' => clienttranslate('Трек дохода +4Б'),
            'victory_points' => 3,
            'player_count' => 2,
            'image_url' => 'img/project-tokens/project-circle/59.png',
        ],
        60 => [
            'number' => 60,
            'color' => 'pink',
            'shape' => 'square',
            'name' => clienttranslate('Код ревью'),
            'price' => '3',
            'effect' => null,
            'effect_description' => clienttranslate('Трек задач +3'),
            'victory_points' => 2,
            'player_count' => 3,
            'image_url' => 'img/project-tokens/project-square/60.png',
        ],
        61 => [
            'number' => 61,
            'color' => 'orange',
            'shape' => 'hex',
            'name' => clienttranslate('Удалённый рабочий стол'),
            'price' => '2',
            'effect' => ['updateTrackSprints' => [['amount' => '+ 2']]],
            'effect_description' => clienttranslate('Трек спринта +2'),
            'victory_points' => 1,
            'player_count' => 3,
            'image_url' => 'img/project-tokens/project-hex/61.png',
        ],
        62 => [
            'number' => 62,
            'color' => 'cyan',
            'shape' => 'circle',
            'name' => clienttranslate('Вебинарная автоворонка'),
            'price' => '2',
            'effect' => ['updateTrack' => [['track' => 'income-track', 'amount' => '+ 1']]],
            'effect_description' => clienttranslate('Трек дохода  +1Б'),
            'victory_points' => 2,
            'player_count' => 3,
            'image_url' => 'img/project-tokens/project-circle/62.png',
        ],
        63 => [
            'number' => 63,
            'color' => 'purple',
            'shape' => 'circle',
            'name' => clienttranslate('Антифрод-система'),
            'price' => '2',
            'effect' => ['updateTrack' => [['track' => 'income-track', 'amount' => '+ 2']]],
            'effect_description' => clienttranslate('Трек дохода +2Б'),
            'victory_points' => 0,
            'player_count' => 3,
            'image_url' => 'img/project-tokens/project-circle/63.png',
        ],
        ...
        64 => [
            ...
            'color' => 'orange',
            'shape' => 'square',
            'name' => clienttranslate('База резюме'),
            'price' => '2',
            'effect' => null,
            'effect_description' => clienttranslate('Трек HR +2'),
            'victory_points' => 1,
            'player_count' => 4,
            'image_url' => 'img/project-tokens/project-square/64.png',
        ],
        65 => [
            'number' => 65,
            'color' => 'cyan',
            'shape' => 'circle',
            'name' => clienttranslate('Партнёрская программа'),
            'price' => '2',
            'effect' => ['updateTrack' => [['track' => 'income-track', 'amount' => '+ 2']]],
            'effect_description' => clienttranslate('Трек дохода  +2Б'),
            'victory_points' => 1,
            'player_count' => 4,
            'image_url' => 'img/project-tokens/project-circle/65.png',
        ],
        66 => [
            'number' => 66,
            'color' => 'purple',
            'shape' => 'circle',
            'name' => clienttranslate('Предиктивная аналитика'),
            'price' => '4',
            'effect' => ['updateTrack' => [['track' => 'income-track', 'amount' => '+ 2']]],
            'effect_description' => clienttranslate('Трек дохода +2Б'),
            'victory_points' => 5,
            'player_count' => 4,
            'image_url' => 'img/project-tokens/project-circle/66.png',
        ],
