    ...
    */
    private const CARD_COUNT = [
        ...
        7 => [
            ...
            'department' => 'technical-department', // Отдел
            'effectDescription' => 'Передвиньте голубые жетоны задач на 3 этапа по треку спринта', // Описание эффекта
            'starterOrFinisher' => 'S', // Стартер или финишер
            'management' => null, // Управление
            'firstGame' => false, // Если первая игра то будет доступны только 4 карты
            'additionalSkill' => null, // Дополнительный навык
        ...
        8 => [
            ...
            'department' => 'technical-department', // Отдел
            'effectDescription' => 'Улучшите на 1 трек задач на панели спринта', // Описание эффекта
            'starterOrFinisher' => 'F', // Стартер или финишер
            'management' => null, // Управление
            'firstGame' => false, // Если первая игра то будет доступны только 4 карты
            'additionalSkill' => null, // Дополнительный навык
        ...
        9 => [
            ...
            'department' => 'technical-department', // Отдел
            'effectDescription' => 'Передвиньте фиолетовые жетоны задач на 3 этапа по треку спринта', // Описание эффекта
            'starterOrFinisher' => 'S', // Стартер или финишер
            'management' => null, // Управление
            'firstGame' => false, // Если первая игра то будет доступны только 4 карты
            'additionalSkill' => null, // Дополнительный навык
        ...
        11 => [
            ...
            'department' => 'technical-department', // Отдел
            'effectDescription' => 'Передвиньте розовые жетоны задач на 3 этапа по треку спринта', // Описание эффекта
            'starterOrFinisher' => 'S', // Стартер или финишер
            'management' => null, // Управление
            'firstGame' => false, // Если первая игра то будет доступны только 4 карты
            'additionalSkill' => null, // Дополнительный навык
        ...
        17 => [
            ...
            'effect' => ['updateTrackDepartmentTechnical' => [['track' => 'cyan-track', 'amount' => '+ 1']]], // Эффект — голубой трек в техотделе
            'department' => 'technical-department', // Отдел
            'effectDescription' => 'Улучшите на 1 пункт голубой трек в техотделее', // Описание эффекта
            'starterOrFinisher' => 'F', // Стартер или финишер
            'management' => null, // Управление
            'firstGame' => false, // Если первая игра то будет доступны только 4 карты
            'additionalSkill' => null, // Дополнительный навык
        ...
        22 => [
            ...
            'department' => 'back-office', // Отдел
            'effectDescription' => 'Передвиньте оранжевые жетоны задач на 3 этапа по треку спринта', // Описание эффекта
            'starterOrFinisher' => 'S', // Стартер или финишер
            'management' => null, // Управление
            'firstGame' => false, // Если первая игра то будет доступны только 4 карты
            'additionalSkill' => null, // Дополнительный навык
        ...
        38 => [
            ...
            'department' => 'sales-department', // Отдел
            'effectDescription' => 'Возьмите 4Б из банка ', // Описание эффекта
            'starterOrFinisher' => 'S', // Стартер или финишер
            'management' => null, // Управление
            'firstGame' => false, // Если первая игра то будет доступны только 4 карты
            'additionalSkill' => null, // Дополнительный навык
        ...
        45 => [
            ...
            'effect' => ["move_task" => ['move_count' => 4, 'move_color' => 'purple']], // Эффект — фиолетовые жетоны, до 5 шагов
            'department' => 'technical-department', // Отдел
        ...
        46 => [
            ...
            'color' => '#0000FF', // Цвет специалиста
            'speciality' => 'Frontend–разработчик', // Специальность специалиста
            'effect' => ["move_task" => ['move_count' => 4, 'move_color' => 'pink']], // Эффект — розовые жетоны, до 5 шагов
            'department' => 'technical-department', // Отдел
        ...
        47 => [
            ...
            'color' => '#0000FF', // Цвет специалиста
            'speciality' => 'Веб–аналитик', // Специальность специалиста
            'effect' => ["move_task" => ['move_count' => 4, 'move_color' => 'orange']], // Эффект — оранжевые жетоны, до 5 шагов
            'department' => 'technical-department', // Отдел
        ...
        50 => [
            ...
            'effect' => ["move_task" => ['move_count' => 4, 'move_color' => 'cyan']], // Эффект — голубые жетоны, до 5 шагов
            'department' => 'back-office', // Отдел
        ...
        61 => [
            ...
            'color' => '#FFFF00', // Цвет специалиста
            'speciality' => 'IT–специалист', // Специальность специалиста
            'effect' => ['updateTrackSprints' => [['amount' => '+ 1']]], // Эффект
            'department' => 'universal', // Отдел
            'effectDescription' => 'Улучшите на 1 трек задач на панели спринта', // Описание эффекта
            'starterOrFinisher' => 'F', // Стартер или финишер
            'management' => null, // Управление
        ...
        64 => [
            ...
            'effect' => ['updateTrackDepartmentTechnical' => [['track' => 'cyan-track', 'amount' => '+ 1']]], // Эффект
            'department' => 'universal', // Отдел
        ...
        67 => [
            ...
            'effect' => ['updateTrackDepartmentTechnical' => [['track' => 'purple-track', 'amount' => '+ 1']]], // Эффект
            'department' => 'technical-department', // Отдел
            'effectDescription' => 'Улучшите на 1 пункт фиолетовый трек в техотделе', // Описание эффекта
            'starterOrFinisher' => 'F', // Стартер или финишер
            'management' => null, // Управление
        ...
        82 => [
            ...
            'color' => '#FFFF00', // Цвет специалиста
            'speciality' => 'Персональный ассистент', // Специальность специалиста
            'effect' => ["move_task" => ['move_count' => 2, 'move_color' => 'cyan']], // Эффект — голубые жетоны, до 5 шагов
            'department' => 'universal', // Отдел
        ...
        83 => [
            ...
            'effect' => ["move_task" => ['move_count' => 2, 'move_color' => 'orange']], // Эффект — голубые жетоны, до 5 шагов
            'department' => 'universal', // Отдел
        ...
        84 => [
            ...
            'color' => '#FFFF00', // Цвет специалиста
            'speciality' => 'Бизнес–аналитик', // Специальность специалиста
            'effect' => ["move_task" => ['move_count' => 2, 'move_color' => 'pink']], // Эффект — голубые жетоны, до 5 шагов
            'department' => 'universal', // Отдел
        ...
        86 => [
            ...
            'color' => '#FFFF00', // Цвет специалиста
            'speciality' => 'Бизнес–аналитик', // Специальность специалиста
            'effect' => ["move_task" => ['move_count' => 2, 'move_color' => 'purple']], // Эффект
            'department' => 'universal', // Отдел
        ...
        94 => [
            ...
            'effect' => ["move_task" => ['move_count' => 5, 'move_color' => 'purple']], // Эффект
            'department' => 'technical-department', // Отдел
        ...
        96 => [
            ...
            'effect' => ["move_task" => ['move_count' => 5, 'move_color' => 'pink']], // Эффект
            'department' => 'back-office', // Отдел
        ...
        98 => [
            ...
            'effect' => ["move_task" => ['move_count' => 5, 'move_color' => 'orange']], // Эффект
            'department' => 'sales-department', // Отдел
        ...
        99 => [
            ...
            'color' => '#FFFF00', // Цвет специалиста
            'speciality' => 'IT–евангелист', // Специальность специалиста
            'effect' => ["move_task" => ['move_count' => 5, 'move_color' => 'cyan']], // Эффект
            'department' => 'universal', // Отдел
        ...
        100 => [
            ...
            'typeName' => 'специалист', // Тип карты название на русском
            'price' => 4, // Цена карты
            'name' => 'Конатнтин', // Имя специалиста
            'color' => '#FFFF00', // Цвет специалиста
            'speciality' => 'IT–евангелист', // Специальность специалиста
            'effect' => ['updateTrackDepartmentTechnical' => [['track' => 'purple-track', 'amount' => '+ 2']]], // Эффект
            'department' => 'universal', // Отдел
